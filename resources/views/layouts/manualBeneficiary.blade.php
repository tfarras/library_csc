...
@section('content')
    ...
    <div class="card mb-3 col-md-4">
        ...
        <div class="card-body" >
            <form action="{{route('beneficiaries.manual.add.save')}}" method="post">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    <input type="number" min="1" max="4" step="1" class="form-control"  required name="study_year" placeholder="Study Year" />
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" required name="address" placeholder="Address" />
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" required name="idnp" placeholder="IDNP" />
                </div>
                <div class="form-group">
